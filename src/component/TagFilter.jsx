export const TagFilter = ({ availableTags, selectedTags, onTagToggle, onClearTags }) => {
  const tagColors = {
    ...
    later: 'from-gray-500 to-gray-600',
  ...
  const getTagColor = (tag) => {
    return tagColors[tag.toLowerCase()] || 'from-teal-500 to-teal-600';
  };
            ...
            return (
              <button
                ...
                className={`group relative overflow-hidden rounded-full px-4 py-2 text-sm font-medium transition-all duration-300 ${
                  isSelected
                    ? `bg-gradient-to-r ${getTagColor(tag)} text-white shadow-lg scale-105`
